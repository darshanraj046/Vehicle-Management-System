...
class InstallWindow(QWidget):
    def __init__(self):
        ...
        buttonsave.setStyleSheet("padding:5px;font-size:17px;background:green;color:#fff;border-radius:10px;margin-bottom:10px;margin-top:10px")
    ...
    def showStepInfo(self):
        ...
        data = {"username": self.input_db_username.text(), "database": self.input_db_name.text(),
