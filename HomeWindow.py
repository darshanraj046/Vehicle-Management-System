...
class HomeScreen(QMainWindow):
    def __init__(self):
        ...
        self.btn_home.setStyleSheet(
            "width:180px;height:120px;font-size:20px;background:#F98866;color:#fff;font-weight:bold;border:1px solid white;border-radius:15px;margin-top:10px;margin-bottom:10px")
        self.btn_add.setStyleSheet(
            "width:180px;height:120px;font-size:20px;background:#20948B;color:#fff;font-weight:bold;border:1px solid white;border-radius:15px;margin-top:10px;margin-bottom:10px")
    ...
    def addHomePageData(self):
        ...
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:#375E97;border:1px solid white;border-radius:50px 20px;margin-bottom:10px;margin-top:10px")
    ...
    def addAddStudentPage(self):
        ...
        name_input.setStyleSheet("color:#fff;padding:10px;font-size:20px")
        mobile_input = QLineEdit()
        mobile_input.setStyleSheet("color:#fff;padding:10px;font-size:20px")
        vehicle_input = QLineEdit()
        vehicle_input.setStyleSheet("color:#fff;padding:10px;font-size:20px")
        vtype = QComboBox()
        vtype.setStyleSheet("color:#fff;padding:10px;font-size:20px;border:1px solid white")
        vtype.addItem("2 Wheeler")
        vtype.addItem("4 Wheeler")

        button = QPushButton("Add Vehicle")
        button.setStyleSheet("color:#fff;padding:8px 0px;font-size:20px;background:green;border:1px solid white;border-radius:10px;margin-bottom:10px;margin-top:10px")
    ...
    def addVehicles(self, name, vehicleno, mobile, index, error_label):
        ...
        if data == True:
            error_label.setText("Vehicle Added Successfully")
            error_label.setStyleSheet("color:#fff;padding:10px;font-size:20px;margin-bottom:10px;margin-top:10px")
        elif data == False:
    ...
    def addManagePage(self):
        ...
        for smalldata in data:
            ...
            self.button_exit.setStyleSheet(
                "color:#fff;padding:5px;font-size:13px;background:#9A9EAB;border:1px solid white")
