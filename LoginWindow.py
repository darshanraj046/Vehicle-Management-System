...
class LoginScreen(QWidget):
    def __init__(self):
        ...
        btn_login.setStyleSheet("padding:5px;font-size:20px;background:green;color:#fff;border:1px solid white;border-radius:10px;margin-bottom:10px;margin-top:10px")
